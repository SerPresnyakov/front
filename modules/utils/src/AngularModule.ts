...
import iAngularModuleConstructor = ak.utils.iAngularModuleConstructor;
import iAngularModule = ak.utils.iAngularModule;
import iRegisterMeta = ak.utils.iRegisterMeta;

export class AngularModule implements iAngularModule {

  module: ng.IModule;

  constructor(moduleName: string, deps: string[]) {
