...
import {materialTemplater} from "./materialTemplater";
import {inspiniaTemplater} from "./inspiniaTemplater";
...
export class Templater {
    ...
    getTemplate(): string {
       switch (this.config.framework) {
           case 'material':
               return  new materialTemplater(this.config,this.ctrlAs).getTemplate();

           case 'inspinia':
               return new inspiniaTemplater(this.config,this.ctrlAs).getTemplate()
       }
    }
    //
    //getTabs(): string {
