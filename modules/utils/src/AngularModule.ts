export class AngularModule implements ak.utils.AngularModule {
  ...
  registerStates(states: ak.config<ng.ui.IState>[]) {
  ...
  registerComponent(components: ak.config<ng.IComponentOptions>[]) {
  ...
  registerDirective(directive: ak.config<() => ng.IDirective>) {
