...
import {Model} from "../../../crudTableModule/src/Model";
...
class CreateCtrl {
    ...
    constructor(public config: CrudStructConfig, public $http:ng.IHttpService, public $mdDialog:IDialogService, public localStorage: ng.local.storage.ILocalStorageService) {
...
export function getDialog($event: any, config: CrudStructConfig): ng.material.IDialogOptions {
